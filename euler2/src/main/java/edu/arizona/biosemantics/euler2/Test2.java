...
public class Test2 {
	...
	public static void main(String[] args) throws EulerException {
		...
		System.out.println("\n=================  CHECK  =================");
		eulerCheck.setInputFile(Configuration.eulerPath + "example/abstract4/abstract4.txt");
		...
		eulerShow.setInputFile(Configuration.eulerPath + "example/abstract4/abstract4.txt");
		eulerShow.setName("iv");
		result = eulerShow.run();
		System.out.println(result);
		
		System.out.println("\n=================  SHOW PW  =================");
		eulerShow.setInputFile(null);
